...
The plugin is written in TypeScript and uses native ES modules. Relative imports
must include a `.js` extension so the emitted declarations work in Node.js.
